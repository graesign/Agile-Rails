...
public class BaanManager implements Serializable {
	...
	/**
	 * Creëert een instantie van de baanmanager zonder een baanstructuur, stations en taxi's.
	 */
	public BaanManager() {
	...
	/** Geeft waar als taxi's vanaf de positie op het eerste spoor en tot de positie op het laatste spoor rijden of wachten en anders onwaar. Deze methode kan ook binnen één spoor controleren.
