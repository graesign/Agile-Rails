...
public class Reis implements Serializable {
	...
	/**
	 * Creëert een reis zonder een taxi, reizigers en reisdetails (vertrekpunt en bestemming).
	 */
	public Reis() {
	...
	/** Creërt een reis met een taxi en reisdetails (vertrekpunt en bestemming).
