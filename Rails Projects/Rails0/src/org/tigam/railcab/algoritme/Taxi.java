...
public class Taxi extends Observable implements Comparable<Taxi>, Serializable {
	...
	/** Cre�ert een <code>Taxi</code> met een ID, naam en het <code>Station</code> waar het zal staan. Bovendien wordt de baanmanager gebruikt voor afstandsberekeningen.
	...
	/** Cre�ert een <code>Taxi</code> met een ID, naam, een observer die op de hoogte gehouden wordt en het <code>Station</code> waar de taxi zal staan. Bovendien wordt de baanmanager gebruikt voor afstandsberekeningen.
	 * @param baanManager De te gebruiken baanmanager
	 * @param ID Identificatienummer van de taxi
	 * @param naam Naam van de taxi
	 * @param station Station waar de taxi staat.
